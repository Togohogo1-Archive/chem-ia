...
\begin{equation}
    k_1 \lbrack \ce{E} \rbrack = (k_{-1} + k_2) \lbrack \ce{ES} \rbrack
\end{equation}

Rearranging gives:
\begin{equation}
    \frac{\lbrack \ce{E} \rbrack \lbrack \ce{S} \rbrack}{\lbrack \ce{ES} \rbrack} = \frac{k_{-1}+k_2}{k_1}
\end{equation}
...
\begin{equation}
    \lbrack \ce{ES} \rbrack = \frac{\lbrack \ce{E} \rbrack \lbrack \ce{S} \rbrack}{K_m}
\end{equation}
...
\begin{equation}
    \lbrack \ce{E_T} \rbrack = \lbrack \ce{E} \rbrack + \lbrack \ce{ES} \rbrack
\end{equation}
