...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{figures/figure_01.png}
    \caption{Conversion of glucose to F-1,6-BP. Intermediate steps are ommited. Image created by moi}
    \label{fig:figure1}
\end{figure}
...
\begin{tabularx}{\textwidth} {
    ...
    \hline
    0.1 & $0.0056 \pm 0.0006$ & Enough condensation to cover top of bottle, solution was very consistent and smooth \\
    \hline
    ...
    \hline
    0.5 & $0.0278 \pm 0.0007$ & When mixing solution, some white foam appeared on top, a good amount of condensation was formed \\
    \hline
    1.0 & $0.0555 \pm 0.0008$ & Less condensation was observed than smaller concentrations, traces of very fine precipitate left at the bottom, depsite stirring with a stir bar \\
    \hline
\end{tabularx}
\end{table}
...
\begin{align*}
    c &= \frac{n}{v} \\
    &= \frac{m/M}{v} \\  %% TODO better equations
    &= 0.02775\,\si{mol.L^{-1}} \\
    \Delta c &= c\left(\frac{\Delta m}{m} + \frac{\Delta v}{v}\right) \\
    &= 0.02775\left(\frac{0.01}{0.5} + \frac{0.0005}{0.1}\right) \\
    &= 0.000694\,\si{mol.L^{-1}} \\
...
\begin{tabularx}{\textwidth} {
    ...
    \hline
    $0.0056 \pm 0.0006$ & $y=35.324x, R^2=0.9962$ & $y=81.96x, R^2=0.9936$ & \dots \\
    \hline
    $0.0139 \pm 0.0006$ & $y=59.095x, R^2=0.9805$ & $y=85.884x, R^2=0.9979$ & \dots \\
    \hline
    $0.0278 \pm 0.0007$ & $y=59.426x, R^2=0.9954$ & $y=82.694x, R^2=0.9886$ & \dots \\
    \hline
    $0.0555 \pm 0.0008$ & $y=36.929x, R^2=0.9789$ & $y=68.013x, R^2=0.9648$ & \dots \\
    \hline
\end{tabularx}
\end{table}
