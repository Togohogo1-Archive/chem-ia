...
\begin{tabularx}{\textwidth} {
    ...
    \hline
    \cellcolor[HTML]{AA0044} Hazard & \cellcolor[HTML]{AA0044} Safety Considerations \\
    \hline
    cell1  text & cell1 dummy text dummy text dummy textcell1 dummy text dummy text dummy textcell1 dummy text dummy text dummy textcell1 dummy text dummy text dummy textcell1 dummy text dummy text dummy text\\
    \hline
\end{tabularx}
\end{table}
