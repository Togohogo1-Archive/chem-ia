...
Additionally, the Michaelis Menten model is consistent with the raw data. From around 0.005\,\ce{M}, the initial reaction velocity starts to become independent of the substrate concentration. This is consistent with the concentration-time graphs because they start off as zero order reaction, and their initial reaction velocity seems to reside in the range where the Michaelis Menten curve starts to become asymptotic.

\section{Evaluation}
The largest potential source of error was deduced to be the temperature of the water, because it was difficult to keep constant, especially in between trials when the warm water bath was refilled. The temperature reading on the magnetic stirring hotplate wasn't the same as the water, meaning it was adjusted a few times, leaving room for a range of solution temperatures, affecting the rate of reaction of carbon dioxide production.

\medskip

Observing the Michaelis Menten plot, the reaction velocity should increase as substrate concentration increases. However, the initial reaction velocity decreases with substrate concentration from 0.25\,\si{g} to 1.00\,\si{g} of glucose added. This implies that the reaction velocity should have been higher when it was not. The two major reasons assumed for this major discrepancy are listed as follows.
...
Secondly, the time between experiments could have been too short. Usually the first experiment of the day yields the most accurate results, but it's possible that not enough time was given carbon dioxide in the \ce{CO2} gas sensor to completely diffuse out, decreasing the effectiveness in the instrument.
