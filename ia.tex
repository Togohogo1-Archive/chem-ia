...
\begin{tabularx}{\textwidth} {
    ...
    \hline
    \multirow[t]{3}{\hsize}{Control} & Volume of deionized water (\si{ml}) & res \\
    \cline{2-3}
    & Temperature of water (\si{\celsius}) & res \\
    \cline{2-3}
    & Mass of yeast used () & res \\
    \cline{2-3}
    & Time for the yeast to fully dissolve and activate & res \\
    \hline
\end{tabularx}
\end{table}
this is what text looks like if it is placed after the table
